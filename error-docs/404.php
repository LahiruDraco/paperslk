...
<!-- InstanceBeginEditable name="head" --><title>Not Found</title>
...
<div id="contentWrap">
  ...
  <!-- InstanceEndEditable -->
     ...
     <h2>Not Found :(</h2>
     <h3>&nbsp;</h3>
     <h3 style="font-size:24px; line-height:normal;">We are sorry but the resouce you are looking was not found. You maybe looking for an outdated resource.</h3>
     <p>&nbsp;</p>
   <!-- InstanceEndEditable -->
        </div>
